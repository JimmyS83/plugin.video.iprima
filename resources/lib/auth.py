...
def login(email, password, device_id):
    ...
    #helpers.log('Auth check TEXT: ' + do_login.text)
    
    if do_login.status_code != 200:
        helpers.displayMessage('Přihlášení selhalo. Zkontrolujte přihlašovací jmémo a heslo.')
        return

    # select profile - https://github.com/archivczsk/archivczsk-doplnky/commit/722645c3828afb2fad7f84e9fda5e245bfb8854a#diff-319eab000dc1d6865e7436d989894c26ee886e7192baa5eb795aae44fdab70b2
    #do_login = s.get('https://auth.iprima.cz/user/profile-select', verify=False, cookies=cookies)
